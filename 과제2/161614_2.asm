...
;	START XORing, Encrypting text.
	...
	Lcopy:
		mov al, StringBuff[esi]
		mov PlainBuff[esi], al
		inc esi
		loop Lcopy

	; PLAINBUFF COPIED ENCRYPTED MSG, Let's deal with NULL

	mov esi, 0
	mov ecx, SIZEOF PlainBuff

	Lsearch:
		mov al, PlainBuff[esi]
		cmp al, 0
